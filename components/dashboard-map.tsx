...
export default function DashboardMap() {
  ...
  useEffect(() => {
    ...
    function drawMap() {
      ...
      // Draw grid lines
      ctx.strokeStyle = "#ddd6fe" // violet-200
      ctx.lineWidth = 1
      ...
      issues.forEach((issue) => {
        ...
        ctx.fillStyle = `rgba(124, 58, 237, ${issue.severity * 0.2})` // violet color
        ctx.fill()
        ...
        switch (issue.type) {
          ...
          case "infrastructure":
            ...
            break
          default:
            ctx.fillStyle = "rgba(124, 58, 237, 0.8)" // violet
        }
      ...
      communities.forEach((community) => {
        ...
        ctx.fillStyle = "rgba(124, 58, 237, 0.1)" // violet color
        ctx.fill()
        ctx.strokeStyle = "rgba(124, 58, 237, 0.3)" // violet color
        ctx.lineWidth = 2
        ctx.stroke()
      })
    }
